...
/**
 * class to represent log in page controller
 * 
...
public class LoginPageController implements Initializable {
	...
	private void handleButtonAction(ActionEvent event) throws IOException {
		...
		try {
			/*
			 * Reference 'bal' to Object BusinessAccessLogin sends parameters to
			 * Business Layer calling method login() which passes the TextBox
			 * parameters usernameBox and passwordBox down the layers.
			 */
			if (bal.login(usernameBox, passwordBox) && (count > 0)) {

				/**
				 * Switch statement so that: user cat 1 -> Reception screen;
				 * user cat 2 'Nurses' -> triage screen ; & user cat 3 'Doctors
				 * -> treatment room
				 */
				...
				case 1:
					...
					homePageParent = FXMLLoader.load(getClass().getResource(
							"/views/FXMLReceptionistPage.fxml"));
					homePageScene = new Scene(homePageParent);
					appStage = (Stage) ((Node) event.getSource()).getScene()
							.getWindow();
					break;
				case 2:
					System.out.println("Staff Category TWO");
					homePageParent = FXMLLoader.load(getClass().getResource(
							"/views/FXMLTriageNurseHomePage.fxml"));
					homePageScene = new Scene(homePageParent);
					appStage = (Stage) ((Node) event.getSource()).getScene()
							.getWindow();
					break;
				case 3:
					...
					homePageParent = FXMLLoader.load(getClass().getResource(
							"/views/FXMLDoctorAssessmentPage.fxml"));
					homePageScene = new Scene(homePageParent);
					appStage = (Stage) ((Node) event.getSource()).getScene()
							.getWindow();
					break;
				case 4:
					...
					homePageParent = FXMLLoader.load(getClass().getResource(
							"/views/FXMLHospitalManagerPage.fxml"));
					homePageScene = new Scene(homePageParent);
					appStage = (Stage) ((Node) event.getSource()).getScene()
							.getWindow();
					break;
	...
	/**
	 * method to initialise log in page controller
	 */
	@Override
