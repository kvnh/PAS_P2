...
public class PatientInfoController implements Initializable {
	...
	/**
	 * sets relevant labels to patient information from the database
	 * these labels are set before screen is changed
	 *  --- see btnPatientInfo on the ReceptionistHomePageController for more info ---
	 * @param patient
	 */
